...
class PolygonCutAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFeatureSink('Result', 'Result', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, supportsAppend=True, defaultValue='TEMPORARY_OUTPUT'))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        parameters['Result'].destinationName = 'Cutting result'
