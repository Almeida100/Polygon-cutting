...
from .polygon_cut_algorithm import PolygonCutAlgorithm


class PolygonCutProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(PolygonCutAlgorithm())
